...
fis = addmf(fis, 'input', 2, 'неудлиненное','trimf', r);
fis = addmf(fis, 'input', 2, 'удлиненное','trimf', sr);
fis = addmf(fis, 'input', 2, 'резко удлиненное','trimf', nr);

fis = addmf(fis, 'input', 1, 'малое', 'trimf', e);
fis = addmf(fis, 'input', 1, 'среднее', 'trimf', el);
fis = addmf(fis, 'input', 1, 'большое', 'trimf', stre);
